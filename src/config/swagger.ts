    ...
    components: {
      ...
      schemas: {
        ...
        Return: {
          ...
          properties: {
            id: { type: "string" },
            returnNumber: { type: "string", example: "RET2025-00001" },
            branchId: { type: "string" },
            saleId: { type: "string" },
            laybyId: { type: "string" },
            quotationId: { type: "string" },
            customerId: { type: "string" },
            reason: { type: "string", example: "Defective product" },
            notes: { type: "string" },
            totalAmount: { type: "number", example: 500.00 },
            totalRefunded: { type: "number", example: 500.00 },
            status: {
              type: "string",
        ...
        ReturnItem: {
          ...
          properties: {
            ...
            inventoryLossId: { type: "string" },
            refundAmount: { type: "number", example: 500.00 },
            notes: { type: "string" },
            createdAt: { type: "string", format: "date-time" },
            updatedAt: { type: "string", format: "date-time" },
          },
        ...
        ReturnRefund: {
          ...
          properties: {
            ...
            paymentMethodId: { type: "string" },
            exchangeRate: { type: "number", example: 1.0 },
            amountInBaseCurrency: { type: "number", example: 500.00 },
            shiftId: { type: "string" },
            referenceNumber: { type: "string" },
