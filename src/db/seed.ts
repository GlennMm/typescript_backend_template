...
async function seed() {
  ...
  const plans = [
    ...
    },
    {
      ...
      name: 'Pro' as const,
      maxUsers: 50,
      features: ['Priority support', 'Up to 50 users', 'Advanced analytics', 'API access'],
    },
    {
      id: nanoid(),
      name: 'Enterprise' as const,
      maxUsers: -1, // Unlimited
      features: ['24/7 support', 'Unlimited users', 'Advanced analytics', 'API access', 'Custom integrations', 'SLA'],
    },
  ];
